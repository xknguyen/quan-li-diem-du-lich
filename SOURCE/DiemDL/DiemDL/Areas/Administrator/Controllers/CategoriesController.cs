...
namespace DiemDL.Areas.Administrator.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        {
            var categories = db.Categories.Include(c => c.Account);
        ...
        public ActionResult Create([Bind(Include = "ID,Name,MetaTitle,DisplayOrder,CreateDate,Status,AccountID,MetaKeywords,MetaDescriptions")] Category category)
        {
            ...
            ViewBag.AccountID = new SelectList(db.Accounts, "ID", "UserName", category.AccountID);
            return View(category);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,MetaTitle,DisplayOrder,CreateDate,Status,AccountID,MetaKeywords,MetaDescriptions")] Category category)
        {
            if (ModelState.IsValid)
            {
