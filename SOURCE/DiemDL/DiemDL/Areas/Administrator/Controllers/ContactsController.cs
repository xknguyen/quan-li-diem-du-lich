...
namespace DiemDL.Areas.Administrator.Controllers
{
    public class ContactsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="ID,Contents,CreateDate,AccountID,Status")] Contact contact)
        {
            ...
            ViewBag.AccountID = new SelectList(db.Accounts, "ID", "UserName", contact.AccountID);
            return View(contact);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="ID,Contents,CreateDate,AccountID,Status")] Contact contact)
        {
            if (ModelState.IsValid)
            {
